...
* Build status: http://travis-ci.org/#!/ptrimble/dreamhost-personal-backup {<img src="https://travis-ci.org/ptrimble/dreamhost-personal-backup.png" />}[https://travis-ci.org/ptrimble/dreamhost-personal-backup]
* Code Coverage: https://coveralls.io/r/ptrimble/dreamhost-personal-backup {<img src="https://coveralls.io/repos/ptrimble/dreamhost-personal-backup/badge.png?branch=master" />}[https://coveralls.io/r/ptrimble/dreamhost-personal-backup]
